 ...
 */
RedParser.prototype.parse = function (rule, currentScope, startPosition) {
 ...
 * @returns {?NodeList}
 */
RedParser.prototype.getScope = function (rule, node) {
 ...
 * @returns {string}
 */
RedParser.prototype.getRuleType = function (rule) {
 ...
 * @returns {string}
 */
RedParser.prototype.doAction = function (action, scope) {
 ...
 * @param {HTMLElement} currentScope
 */
RedParser.prototype.on = function (event, rule, currentScope) {
